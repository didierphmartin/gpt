...
final class NooaGeneratorCompileTest extends TestCase
{
    ...
    {
        $tmp = sys_get_temp_dir() . "/nooa_{$suffix}_" . getmypid() . '.py';
    ...
    public function testDiamondCompiles(): void
    {
        ...
        [$rc, $out] = self::pyCompile(NOOAGenerator::emitNooa(self::diamondAnalyzed()), 'diamond');
        $this->assertSame(0, $rc, "Diamond NOOA failed py_compile:\n{$out}");
    }
    ...
    public function testMcpFixtureCompiles(): void
    {
        ...
        [$rc, $out] = self::pyCompile(NOOAGenerator::emitNooa($a), 'mcp');
    ...
    public function testStartDocumentsFixtureCompiles(): void
    {
        ...
        [$rc, $out] = self::pyCompile(NOOAGenerator::emitNooa($a), 'docs');
        $this->assertSame(0, $rc, "Start-documents NOOA failed py_compile:\n{$out}");
    }
}
