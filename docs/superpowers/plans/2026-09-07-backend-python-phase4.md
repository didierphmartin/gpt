...
**Files:** create `app/agent_team/controllers/workflow_controller.py`; modify `app/routes.py` (`# WORKFLOWS` rows PHP 348–350, 374–375, 381–384, 391–392, 402–405 in PHP order — NOT 351–354 generate-*, NOT 376–380 run*/toolResult); tests `tests/unit/test_workflow_controller.py`, `tests/differential/test_workflows.py`.
