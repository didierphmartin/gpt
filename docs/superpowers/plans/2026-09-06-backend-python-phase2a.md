...
def test_error_mapping():
    ...
    assert str(ei.value).startswith('claude API error: ') and 'Response: boom' in str(ei.value) and ei.value.getHttpStatusCode() == 500
